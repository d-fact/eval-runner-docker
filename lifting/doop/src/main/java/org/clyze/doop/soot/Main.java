...
public class Main {
    ...
    private static Annotations annots;
    ...
    public static void main(String[] args) throws Exception {
        ...
        annots = new Annotations("/tmp/annotations.tsv");

        SootParameters sootParameters = new SootParameters();
        try {
            sootParameters.initFromArgs(args);

            PresenceCondition.resetDefaultPC(sootParameters.getDefaultPC());
    ...
    private static void produceFacts(SootParameters sootParameters) throws Exception {
        ...
        try (Database db = new Database(new File(sootParameters.getOutputDir()))) {
            ...
            FactWriter writer = new FactWriter(db, rep, reportPhantoms, annots);
            ThreadFactory factory = new ThreadFactory(writer, sootParameters._ssa, reportPhantoms, annots);
            SootDriver driver = new SootDriver(factory, classes.size(), sootParameters._cores, sootParameters._ignoreFactGenErrors, annots);

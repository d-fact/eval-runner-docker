...
class DexFactWriter extends JavaFactWriter {
    ...
    public void generateFacts(BasicJavaSupport java, DexParameters dexParams,
                              String apkName, String dexEntry, DexBackedDexFile dex, Annotations annots)
        ...
        DexDriver driver = new DexDriver(factory, totalClasses, dexParams._cores, false, annots);
